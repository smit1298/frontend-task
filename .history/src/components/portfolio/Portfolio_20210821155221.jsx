      ...
      <Row>
        ...
        <div className="col-md-6">
          <div className="meet-me ms-4">
            <h2 className="text-center" style={folio}>About Me</h2>
            <p>
              I am an inventive Web Developer, creates novel site designs and innovative
            ...
            <p>
              Fully proficient in &nbsp;
              <b>HTML, CSS, BOOTSTRAP, Git, Javascript, ReactJs, React-Bootstrap, MDB React  and Material-UI</b>. 
            </p>
          </div>
